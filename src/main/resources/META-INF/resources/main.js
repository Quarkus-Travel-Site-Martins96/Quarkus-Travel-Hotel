...
class HotelViewComponent {
    constructor(rest) {
        this.rest = rest;
        this.hotelUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_1__["Environment"].getHotelHost() + "/hotel/info/";
        this.rest = rest;
    ...
    ngOnInit() {
        if (this.hotel || this.hotel === new _vo_interface_objects__WEBPACK_IMPORTED_MODULE_2__["HotelVO"]()) {
            ...
            this.sub = this.rest.sendGet(this.hotelUrl + this.hotelId, new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]({
...
class GalleryViewComponent {
    constructor(rest) {
        this.rest = rest;
        this.hotelUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_1__["Environment"].getHotelHost() + "/hotel/images/";
        this.rest = rest;
...
class AppComponent {
    constructor() {
        ...
        if (!this.id) {
            window.location.href = _environments_environment__WEBPACK_IMPORTED_MODULE_0__["Environment"].getHomeHost();
        }
    }
}
